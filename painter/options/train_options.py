...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--G_render', action='store_true',default=False,
                            help='whether use generative model G as the render')
        ...
        parser.add_argument('--controler_points_w', type=int, default=0,
                            help='frequency of showing training results on console')
        parser.add_argument('--controler_points_h', type=int, default=0,
                            help='frequency of showing training results on console')
